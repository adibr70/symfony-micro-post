...
class __TwigTemplate_fa90c90b65504450fc8c0e87ffab90219ef25535ec5263b18d4b6ecb5aefbd1a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  117 => 14,  108 => 11,  104 => 10,  98 => 9,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    {% for id, post in posts %}
        ...
        <p><a href=\"{{ path('blog-show', {'id' : id}) }}\">ID {{ id }}</a></p>
        <h3>{{ post.title }}</h3>
        <p>{{ post.text }}</p>
        
    {% endfor %}

{% endblock %}", "blog/index.html.twig", "/home/vagrant/symfony-01/symfony-micropost-src/templates/blog/index.html.twig");
    }
}
