...
class __TwigTemplate_b9347fdf99efac5339238a99ece8c1fd2bd014d12d75f450b5b6c7d43a0b0b21 extends Template
{
    private $source;
    private $macros = [];
    ...
    <form action=\"";
        ...
        echo "</label>
            ...
            <div class=\"form-group clearfix\">
                <button type=\"submit\" id=\"Login\" name=\"Login\" class=\"btn-secondary btn float-left\">";
        // line 24
        ...
        // line 25
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Not have an account?"), "html", null, true);
        echo " <a href=\"";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_register");
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Register now!"), "html", null, true);
        echo "</a></div>
            </div>
...
";
    ...
    {
        return array (  130 => 28,  126 => 27,  117 => 25,  113 => 24,  106 => 20,  100 => 17,  95 => 15,  90 => 13,  85 => 11,  82 => 10,  76 => 7,  73 => 6,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    <form action=\"{{ path('security_login') }}\" method=\"post\">
        <div>
            ...
            <div class=\"form-group clearfix\">
                <button type=\"submit\" id=\"Login\" name=\"Login\" class=\"btn-secondary btn float-left\">{{ 'Login'|trans }}</button>
                <div class=\"float-right\">{{ 'Not have an account?'|trans }} <a href=\"{{ path('user_register') }}\">{{ 'Register now!'|trans }}</a></div>
            </div>
